...
(function(window, document, undefined) {
    ...
    function hsv2rgb(hsv) {
        ...
        return { r: r, g: g, b: b, hex: "#" + (16777216 | value).toString(16).slice(1), value: value };
    }
    ...
    function slideListener(ctx, slideElement, pickerElement) {
        return function(evt) {
            ...
            ctx.callback && ctx.callback(c.hex, { h: ctx.h - hueOffset, s: ctx.s, v: ctx.v }, { r: c.r, g: c.g, b: c.b }, c.value, undefined, mouse);
        }
    };
    ...
    function pickerListener(ctx, pickerElement) {
        return function(evt) {
            ...
            var c = hsv2rgb(ctx);
            ctx.callback && ctx.callback(c.hex, { h: ctx.h - hueOffset, s: ctx.s, v: ctx.v }, { r: c.r, g: c.g, b: c.b }, c.value, mouse);
        }
    };
    ...
    function ColorPicker(slideElement, pickerElement, callback) {
        ...
        if (!callback) {
            ...
            this.callback = function(hex, hsv, rgb, value, pickerCoordinate, slideCoordinate) {
    ...
    */
     ...
     */
     function setColor(ctx, hsv, rgb, hex) {
         ...
         ctx.callback && ctx.callback(hex || c.hex, { h: ctx.h, s: ctx.s, v: ctx.v }, rgb || { r: c.r, g: c.g, b: c.b }, c.value, mousePicker, mouseSlide);
